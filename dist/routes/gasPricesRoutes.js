 ...
 */
router.get('/gas-prices', [validators_js_1.validateApiKey, validators_js_1.validateParameter], (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        // Call the controller function to handle the request
        yield (0, gasPriceController_js_1.getGasPrices)(req, res);
    }
    catch (error) {
