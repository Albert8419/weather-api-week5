...
const config_1 = require("./config"); // Assuming you export it from config.ts as shown in the previous step.
const getGasPrices = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const axiosInstance = (0, config_1.getGasApiAxiosClient)(); // Use the Axios instance configured with the API key and host.
